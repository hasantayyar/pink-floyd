...
$url = "http://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist=".urlencode($artist)."&api_key=".$lastfmApikey."&format=json";
$urlSongs = "http://ws.audioscrobbler.com/2.0/?method=album.getinfo&api_key=".$lastfmApikey."&artist=".urlencode($artist)."&format=json&album=";
